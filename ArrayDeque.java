/**
 * Implementation of an ArrayDeque.
 *
...
public class ArrayDeque<T> {
    ...
    public void addFirst(T data) { //
        ...
        if (backingArray[mod((front - 1), backingArray.length)] == null) {
    ...
    public void addLast(T data) {
        ...
        if (backingArray[mod((front + size), backingArray.length)] == null) {
    ...
    public T removeFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Deque is empty and can't be "
                    + "removed from.");
        } else {
            T needed = backingArray[front];
    ...
    public T removeLast() {
        if (size == 0) {
            ...
            T needed = backingArray[mod((front + size - 1),
                    backingArray.length)];
            backingArray[mod((front + size - 1),
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Deque is empty and can't return"
                    + " a value.");
        } else {
    ...
    public T getLast() {
        if (size == 0) {
            ...
            return backingArray[mod((front + size - 1),
                    backingArray.length)];
        }
    }
